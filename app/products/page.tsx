...
import { Mail, MessageCircle, Shield, Zap, Check, Cpu, Keyboard, Palette, Code2 } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: 'Designed specifically for programmers with strategic key placement',
  ...
  const configurations = [
    {
      ...
      features: ['Split PCB', 'Basic switches', '3D printed case', 'Standard keycaps'],
      popular: false
    },
    {
      ...
      features: ['Premium switches', 'Aluminum case', 'Custom keycaps', 'TRRS cable'],
      popular: true
    },
    {
      ...
      features: ['Rotary encoder', 'OLED display', 'Premium materials', 'Custom firmware'],
      popular: false
    }
  ]

  const specifications = [
    { category: 'Layout', items: ['42-key split ortholinear', 'Ergonomic positioning', 'Thumb cluster design'] },
    { category: 'Hardware', items: ['RP2040 Zero MCU', 'Hot-swap sockets', 'USB-C connectivity'] },
    { category: 'Build', items: ['CNC aluminum case', 'Premium switches', 'Custom keycaps'] },
    { category: 'Software', items: ['QMK firmware', 'VIA compatibility', 'Custom layouts'] }
  ]
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
              Hand-crafted mechanical keyboards designed for developers. Built on-demand with premium materials 
              and unlimited customization possibilities.
            </p>
            <div className="flex flex-wrap justify-center gap-2 text-sm text-muted-foreground">
              <span className="px-3 py-1 bg-primary/10 text-primary rounded-full">On-Demand Manufacturing</span>
              <span className="px-3 py-1 bg-secondary/10 text-secondary rounded-full">QMK Compatible</span>
              <span className="px-3 py-1 bg-accent/10 text-accent rounded-full">Premium Materials</span>
            </div>
          </div>
              ...
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-muted group shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-8">
                  <div className="bg-background/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                    <h3 className="text-2xl font-bold mb-2 text-white">{productImages[activeImageIndex].title}</h3>
                    <p className="text-white/90 text-lg">{productImages[activeImageIndex].description}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="mb-8">
                ...
                <p className="text-muted-foreground">
                  Explore every detail of our handcrafted ergonomic split keyboard
                </p>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">Why Developers Choose Our Keyboards</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Every feature is designed with productivity and comfort in mind, backed by years of development experience.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">Build Configurations</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Choose your perfect setup. Each keyboard is built to order with your specifications.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Built with premium components and modern technology for the ultimate typing experience.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {specifications.map((spec, index) => (
              <div key={index} className="p-6 rounded-xl bg-card border border-border">
                <h3 className="text-lg font-semibold text-primary mb-4">{spec.category}</h3>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              From consultation to delivery, we handle every step of your custom keyboard build.
            </p>
          </div>

          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              { step: '01', title: 'Consultation', description: 'Discuss your needs and preferences' },
              { step: '02', title: 'Design', description: 'Customize layout, switches, and materials' },
              { step: '03', title: 'Build', description: 'Hand-assembly with quality testing' },
              { step: '04', title: 'Delivery', description: 'Shipped with setup guide and support' }
            ].map((item, index) => (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold mb-6">Ready to Build Your Dream Keyboard?</h2>
            <p className="text-xl text-muted-foreground mb-8">
              Starting at ₹7,000. Each keyboard is built to order with a 2-3 week delivery time.
            </p>
