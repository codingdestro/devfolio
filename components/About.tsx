      ...
      <div className="w-3xl flex flex-col items-center justify-center my-40">
        ...
        <section className="w-full text-center " ref={aboutSection}>
          ...
          <p>
            ...
            ⚙️ and <strong>TypeScript</strong> 💻. I’m also comfortable working
            with <strong>Next.js</strong> 🚀, <strong>Tailwind CSS</strong> 🖌️,
            and have a solid understanding of <strong>HTML</strong>,{" "}
            <strong>CSS</strong>, and <strong>JavaScript</strong> 🌐. I’m all
            about building apps that are not only functional but also
